...
export class LoginService {
  ...
  login() {
    ...
    // location.href = `//${location.hostname}${port}${contextPath}oauth2/authorization/oidc?realm=${realm}`;
    location.href = `//${location.hostname}${port}${contextPath}oauth2/authorization/${realm}?realm=${realm}`;
  }
